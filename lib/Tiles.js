...
module.exports = {
  ...
  mapnikLayer: function( table, name, minZoom, maxZoom, type ){
    ...
    layer += '<Parameter name="host">localhost</Parameter>';
    layer += '<Parameter name="dbname">koopdev</Parameter>';
    layer += '<Parameter name="user">chelm</Parameter>';
    layer += '<Parameter name="password"></Parameter>';
    layer += '<Parameter name="table">"'+table+'"</Parameter>';
  ...
  createMapnikStyleSheet: function(file, data, params, callback){
    console.log(config.db.postgis.conn)
    var self = this;
