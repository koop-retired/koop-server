...
module.exports = {
  ...
  createMapnikStyleSheet: function(file, data, params, callback){
    ...
    while ( i >= 0 ) {
      ...
      layers.push( self.mapnikLayer( table, layer.name, layer.minScale, layer.maxScale, layer.            geometryType ) );
      i--;
    } 
  ...
  createServiceTile: function(params, stylesheet, callback){
    var p = [ config.data_dir + 'tiles', params.key, params.format, params.z, params.x].join('/');
    var file = p + '/' + params.y + '.' + params.format;
