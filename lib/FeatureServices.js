...
module.exports = {
  ...
  info: function( data, layer, params, callback ){
    ...
    //console.log(!json.fullExtent.minx && !json.fullExtent.miny, json.fullExtent.xmin, json.fullExtent.xmin)
    if (!json.fullExtent.xmin && !json.fullExtent.xmin && (data.features || data[0].features)){
      json.type = 'Table';
    }
