...
exports.fromEsri = function( fields, json, callback ){
    ...
    json.features.forEach(function(f, i){
      try {
        ...
        if ( dateField ){
          newFeature.properties[dateField] = new Date(newFeature.properties[dateField]).toISOString();
        }
        geojson.features.push( newFeature );
      } catch (e){
        if ( dateField ){
          feature.attributes[dateField] = new Date(feature.attributes[dateField]).toISOString();
        }
        newFeature = {
            id: i+1,
            properties: f.attributes,
